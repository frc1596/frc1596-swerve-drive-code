...
/*      public ModulePosition getModulePosition() {
  ...
  public void drive(
    ...
    SwerveDriveKinematics.desaturateWheelSpeeds(
        ModuleMap.orderedValues(moduleStates, new SwerveModuleState[0], DriveConstants.kMaxSpeedMetersPerSecond), rotation);
  ...
  public void setOdometry(Pose2d pose) {
    ...
    m_odometry.resetPosition(getHeadingRotation2d(), null, pose);
    m_gyro.reset();
