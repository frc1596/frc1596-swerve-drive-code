...
public final class Constants {
  ...
  public static final class CanConstants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = 184.658;// -Math.toRadians(0.0);

    public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 8;
    public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 7;
    public static final int FRONT_RIGHT_MODULE_STEER_CANCODER = 3;
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = 13.975;// -Math.toRadians(-42);

    public static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 4;
    public static final int BACK_LEFT_MODULE_STEER_MOTOR = 3;
    public static final int BACK_LEFT_MODULE_STEER_CANCODER = 0;
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = 311.660    ;// -Math.toRadians(0.0);
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = 90.264;// -Math.toRadians(-105);
  ...
  public static final class DriverConstants {
    ...
    public static double kRotationSlew = 5.0;
