...
import frc.robot.commands.Grippers.OpenGrippers;
...
public class AutoFactory {
    ...
    public AutoFactory(DriveSubsystem drive, TurnArmSubsystem turnArm, LinearArmSubsystem linArm) {
     ...
     //   eventMap.put("pickupcube", pickupCube());
        ...
        m_autoChooser.setDefaultOption("UniversalAuto", 0);
    ...
    public Command getAutonomousCommand() {
        ...
        switch (m_autoChooser.getSelected()) {
            ...
            case 0:
                new SequentialCommandGroup(new InstantCommand(()->m_grp.openGrippers()));
